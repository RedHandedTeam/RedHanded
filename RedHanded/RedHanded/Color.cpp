...
//------------------------------------------------------------------------------------------------------
Color Color::operator+(const GLfloat rhs)
{
...
//------------------------------------------------------------------------------------------------------
Color& Color::Lerp(Color& secondColor, GLfloat delta, GLfloat epsilon)
{
...
//------------------------------------------------------------------------------------------------------
Color& Color::Lerp(ColorType secondColor, GLfloat delta, GLfloat epsilon)
{
...
//------------------------------------------------------------------------------------------------------
Color& Color::Lerp(GLfloat secondAlpha, GLfloat delta, GLfloat epsilon)
{
